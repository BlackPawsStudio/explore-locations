      ...
      <div className="flex flex-col gap-3">
        <div className="bg-white px-3 pb-5 pt-4 lg:rounded-md lg:px-6 lg:pt-4">
          ...
          <div className="mb-8 leading-8 tracking-wider">
            ...
            {distance.toLocaleString("en-US")} kilometers, which is the
            equivalent of {distanceMiles.toLocaleString("en-US")} miles.
          </div>
          <div className="mb-8 leading-8 tracking-wider">
          ...
          <div className="mb-8 leading-8 tracking-wider">
            ...
            to drive from {from} to {to}. However, the driving time depends on
            several factors such as: road conditions, traffic, weather and
            stops.
          </div>
          <div className="mb-8 leading-8 tracking-wider">
          ...
          <div className="grid grid-cols-2 gap-y-[1.6rem]">
            <span className="mb-6 hidden font-bold lg:block">
              Average Speed
            </span>
        ...
        <SearchModule
          title="Explore other driving routes"
          placeholder="Search driving routes"
          defaultFilter="driving-route"
        />
      </div>
