...
export const DescriptionSection = ({
  ...
  <section className="relative w-full bg-gradientLeft lg:mb-6">
    <div className="container z-10 pb-9 pt-6 lg:pb-24 lg:pt-16">
      ...
      <h3 className="relative z-10 mx-auto px-3 text-center text-sm leading-[1.8rem] tracking-wider text-white lg:w-3/5 lg:text-base lg:leading-8">
        {description}
      </h3>
    </div>
    <Image
